...
def main():
    ...
    if user_age >= PETURKSBOUIPO_AGE:
        ...
        print(
            "You cannot vote in Peturksbouipo where the voting age is "
            + str(PETURKSBOUIPO_AGE)
            + "."
        )
    if user_age >= STANLAU_AGE:
        ...
        print(
            "You cannot vote in Stanlau where the voting age is "
            + str(STANLAU_AGE)
            + "."
        )
    if user_age >= MAYENGUA_AGE:
        ...
        print(
            "You cannot vote in Mayengua where the voting age is "
            + str(MAYENGUA_AGE)
            + "."
        )
